...
*Tip: For these next two problems, work from the inside out! First, look inside the parenthesis and work your way out to the negation.*
...
~~~
<!--
*Tip: For this problem, first consider the negation of p and q and then consider if the disjunction of these negations is true.*
...
<video controls width="500" src="https://helenmeskhidze.github.io/Videos/Examples%20for%20videos/TruthTableExample.mp4" /> </video>
